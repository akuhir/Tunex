...
enum SongSortOption { dateAddedNewest, dateAddedOldest, titleAZ, titleZA, artist, album, durationLongest, durationShortest }

enum AlbumSortOption { titleAZ, titleZA, artist, trackCount }

extension SongSortOptionLabel on SongSortOption {
  String get label => switch (this) {
        SongSortOption.dateAddedNewest => 'Date added (newest first)',
        SongSortOption.dateAddedOldest => 'Date added (oldest first)',
