...
class _SearchScreenState extends ConsumerState<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final sortedMatchingSongs = applySongSort(
      matchingSongs,
      sortOption,
      title: (s) => s.title,
      artist: (s) => s.artist,
                ...
                : (matchingSongs.isEmpty &&
                    ...
                    : ListView(
                        ...
                        children: [
                          ...
                          if (sortedMatchingSongs.isNotEmpty) ...[
                            _ResultSectionLabel('Songs'),
                            ...sortedMatchingSongs.map(
                              (song) => SongTile(
                                song: song,
                                onTap: () => ref
                                    ...
                                    .playQueue(
                                      sortedMatchingSongs,
                                      startIndex: sortedMatchingSongs.indexOf(song),
                                    ),
                                onMoreTap: () =>
